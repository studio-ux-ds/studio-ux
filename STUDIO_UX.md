...
> **PT:** na `v1.2.42`, o `AppShell` passou a revelar o grupo recém-aberto dentro da rolagem da Sidebar, sem deslocar o foco. **EN:** in `v1.2.42`, `AppShell` now reveals a newly opened group within Sidebar scrolling without moving focus.
