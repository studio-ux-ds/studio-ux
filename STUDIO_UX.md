...
> **PT:** na `v1.2.43`, o `AppShell` ganhou `topbarActions`, slot oficial para controles globais do sistema consumidor sem duplicar a TopBar. **EN:** in `v1.2.43`, `AppShell` gained `topbarActions`, the official slot for consuming-system global controls without duplicating the TopBar.
